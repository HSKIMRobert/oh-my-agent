...
## [8.0.0](https://github.com/HSKIMRobert/oh-my-agent/compare/cli-v7.14.1...cli-v8.0.0) (2026-05-21)
...
* add telemetry opt-in to oma-config for all vendors ([22265cd](https://github.com/HSKIMRobert/oh-my-agent/commit/22265cd913310693418cfb1d04cdeaf04f00ecd5))
* add Windows support with PowerShell installer and link fallbacks ([#309](https://github.com/HSKIMRobert/oh-my-agent/issues/309)) ([31a72b6](https://github.com/HSKIMRobert/oh-my-agent/commit/31a72b63417efed508d98a64792856b174874f41))
* **agents:** add docs-curator agent for orchestrated docs sync ([e5ffa5b](https://github.com/HSKIMRobert/oh-my-agent/commit/e5ffa5b2d3a2a878a3ddb26c93b5e071e9c66849))
* **agent:** wire T11 findings, T12 difficulty, T15 quota into spawn path ([aff6788](https://github.com/HSKIMRobert/oh-my-agent/commit/aff678839b09cb349b713f1eeac6c11d9d78b3b3))
* **apm:** add Microsoft APM package distribution ([672717c](https://github.com/HSKIMRobert/oh-my-agent/commit/672717cc1233e318a2069627fa385e5a3efd022a))
* **backend:** route oma verify backend through stack.yaml manifest ([453873a](https://github.com/HSKIMRobert/oh-my-agent/commit/453873a8451fb33450259178c8826ef467c960a9))
* **benchmarks:** add 5-axis multiaxis scoring system ([26b0ad8](https://github.com/HSKIMRobert/oh-my-agent/commit/26b0ad850cf751d439cae0a1273a0b6f0b683f8e))
* **benchmarks:** add multi-judge averaging for spec and visual axes ([c1c0f74](https://github.com/HSKIMRobert/oh-my-agent/commit/c1c0f7472ec019c6b21510796e8a050f75433635))
* **claude:** add skillListingBudgetFraction to recommended settings ([8fdf933](https://github.com/HSKIMRobert/oh-my-agent/commit/8fdf9336714330d41ce571e91b22df35a8f4bf97))
* **cli:** add model:check, model:probe, model:propose commands ([abd74fb](https://github.com/HSKIMRobert/oh-my-agent/commit/abd74fbb2dc7974a2818094c522f65ad7e115837))
* **cli:** add oma image command with codex and pollinations providers ([a05cb19](https://github.com/HSKIMRobert/oh-my-agent/commit/a05cb1969f38c6db67f90fb4717ee891a0115386))
* **cli:** auto-register skills from .agents/skills/ frontmatter ([050f16f](https://github.com/HSKIMRobert/oh-my-agent/commit/050f16fd40cda809fa83d19aed6a06edb8b3e45f))
* **cli:** generate .github/prompts wrappers for copilot vendor ([d9502ee](https://github.com/HSKIMRobert/oh-my-agent/commit/d9502ee1504ca3d3d3a90c27b467e0b4b7ffec83))
* **cli:** mirror workflows into .codex/skills for Codex $ invocation ([03cf790](https://github.com/HSKIMRobert/oh-my-agent/commit/03cf7900276539368771282ba12f8afa2b9e15f2))
* **cli:** preserve user-upgraded effortLevel in claude settings ([4e0f50f](https://github.com/HSKIMRobert/oh-my-agent/commit/4e0f50f52f47e138587f86dc9063fc88daba8c2a))
* **cli:** register Serena MCP for Codex and Qwen runtimes ([688e06a](https://github.com/HSKIMRobert/oh-my-agent/commit/688e06abab474f32bc17076ca8e6bf4a14344b8d))
* **cli:** show added/removed skills and workflows on update ([c03baf9](https://github.com/HSKIMRobert/oh-my-agent/commit/c03baf9f168037f302b32d70b0924ee59fdad828))
* **codex:** force-enable goals and child_agents_md features ([cee3377](https://github.com/HSKIMRobert/oh-my-agent/commit/cee3377cdaea2d47b161e650e3057a6cd26876ec))
* **composer:** skip CHARTER_CHECK for Simple tasks ([4798b5e](https://github.com/HSKIMRobert/oh-my-agent/commit/4798b5e168c7747b3c084241176f05d9a01dafda))
* **config:** consolidate to model_preset single-file config ([294b8df](https://github.com/HSKIMRobert/oh-my-agent/commit/294b8df23b1dc3b9407f64041d0d421aa1caec5a))
* **config:** support dual-format agent_cli_mapping ([6c51ea5](https://github.com/HSKIMRobert/oh-my-agent/commit/6c51ea5f6a3675a726f2c39b29f92fb95f099fd8))
* **cursor:** promote cursor to first-class vendor ([12a3c3d](https://github.com/HSKIMRobert/oh-my-agent/commit/12a3c3d823829cbfa901accbb8480864e34e0b58))
* **defaults:** add Profile B baked-in agent defaults ([fb3da52](https://github.com/HSKIMRobert/oh-my-agent/commit/fb3da52d37731b2dfdd64145442f7917b4b3fdc4))
* **defaults:** add qwen-only runtime profile ([44d3034](https://github.com/HSKIMRobert/oh-my-agent/commit/44d3034214747a5a22de72f0d9fd632b88ce8000))
* **dispatch:** add qwen runtime with forced external fallback ([8782b02](https://github.com/HSKIMRobert/oh-my-agent/commit/8782b02dbbd0fa934202d3eb13d115c91ddcd742))
* **dispatch:** add resolveAgentPlan for per-agent model and effort ([f0b4549](https://github.com/HSKIMRobert/oh-my-agent/commit/f0b454942f3680429dfb3daeb4bbf2ca2174471d))
* **dispatch:** wire resolveAgentPlan into planDispatch spawn path ([c92fd99](https://github.com/HSKIMRobert/oh-my-agent/commit/c92fd991bba5ac9d147e22683e1037fede865793))
* **docs:** add 'oma docs i18n' for translation drift detection ([19c2efb](https://github.com/HSKIMRobert/oh-my-agent/commit/19c2efb719cc38e600241f968490ab2d7c3738cd))
* **docs:** add 'oma docs lint' for i18n style anti-patterns ([048804d](https://github.com/HSKIMRobert/oh-my-agent/commit/048804d2210152c46dcf841ef64248f847686e81))
* **docs:** introduce oma-docs verify and sync skill ([#326](https://github.com/HSKIMRobert/oh-my-agent/issues/326)) ([dc18e83](https://github.com/HSKIMRobert/oh-my-agent/commit/dc18e83f30a010812577bb83ff56b6990fb786b7))
* **docs:** swap tinyld for eld and add wrong-language rule ([89855df](https://github.com/HSKIMRobert/oh-my-agent/commit/89855dfbcd9ce38fc1008bef4ada45a84bccc632))
* **doctor:** add --profile flag with auth matrix ([031e234](https://github.com/HSKIMRobert/oh-my-agent/commit/031e234839ecfd4c026e46a0039dbfb361bf0915))
* **frontend:** ban framer-motion, enforce motion/react ([2810724](https://github.com/HSKIMRobert/oh-my-agent/commit/28107249f706fad8046de14fa99193d028bf5f6d))
* **frontend:** mandate next@16+ and react@19+, ban next &lt; 16 ([cd96046](https://github.com/HSKIMRobert/oh-my-agent/commit/cd9604644bbd456d37900775099f44df9ded94bc))
* **hooks:** add intent regex patterns and sanitize hardening ([f5800e1](https://github.com/HSKIMRobert/oh-my-agent/commit/f5800e1e34493ead0b3dfb6aa594e2400623c57b))
* **hooks:** register oma-image keyword triggers ([312cb9c](https://github.com/HSKIMRobert/oh-my-agent/commit/312cb9c9ef99240b8c74689c83e803efbb61e296))
* **hooks:** resolve unknown slash commands via hidden skill lookup ([ef15f15](https://github.com/HSKIMRobert/oh-my-agent/commit/ef15f15ab340d4b0909135b3a81048e3b8e447f3))
* **image:** add --reference flag with sanitized unique filenames ([0f0031b](https://github.com/HSKIMRobert/oh-my-agent/commit/0f0031b4ed69e4fce9e972895f2b9359f5a7d4e6))
* **image:** add --reference flag with sanitized unique filenames ([ee8b574](https://github.com/HSKIMRobert/oh-my-agent/commit/ee8b574e6552120430557c3ae0ed27bb7438afb9))
* **install:** add --yes flag for non-interactive install ([ff7ba68](https://github.com/HSKIMRobert/oh-my-agent/commit/ff7ba683b60edd7b9526a1edaf623e00e7f4072d))
* **install:** add Hermes Agent skill export with HOME consent gate ([#305](https://github.com/HSKIMRobert/oh-my-agent/issues/305)) ([6159cc6](https://github.com/HSKIMRobert/oh-my-agent/commit/6159cc600d6ec3413766576f5c02ddec814b149b))
* **install:** ensure docs/generated/ is gitignored after install ([37b9b67](https://github.com/HSKIMRobert/oh-my-agent/commit/37b9b678d0f835176d12793705708851ec6e4091))
* **install:** version-gated defaults.yaml upgrades ([94299e6](https://github.com/HSKIMRobert/oh-my-agent/commit/94299e62055d61aff33fda4e5a8e0de8883af4bf))
* **io:** add gitignore module and auto-ignore docs/generated ([f033332](https://github.com/HSKIMRobert/oh-my-agent/commit/f033332b7c49fedb49189713fea5d1f462ed161f))
* **io:** add session quota cap accounting ([efa7aaf](https://github.com/HSKIMRobert/oh-my-agent/commit/efa7aaf4e8d03ce124c9d665c102c0baa0245709))
* **io:** add shared findings cache (L3) ([ade8dac](https://github.com/HSKIMRobert/oh-my-agent/commit/ade8dac91e17f7e9de45b56bef630fcd746d9dd2))
* **market:** add discover-competitors (LLM-first peer-entity candidates) ([e19ee27](https://github.com/HSKIMRobert/oh-my-agent/commit/e19ee27001dd8bafc8b988141a4763868a8fa23f))
* **market:** add oma-market skill with deterministic CLI pipeline ([3d42406](https://github.com/HSKIMRobert/oh-my-agent/commit/3d4240661aa3b202e660099c44a4d35245455122))
* **models:** upgrade default models to gpt-5.5 and qwen3.6-plus ([bbcd072](https://github.com/HSKIMRobert/oh-my-agent/commit/bbcd07273fd817083d8d86a7021b5efd7ef9c34f))
* **oma-db:** add verification discrepancy audit guidance ([16a8130](https://github.com/HSKIMRobert/oh-my-agent/commit/16a8130a47406e9817d447d8c8822c989cdeaaf1))
* **oma-translator:** add tailing-negation rule and curly-quote check ([0697d6a](https://github.com/HSKIMRobert/oh-my-agent/commit/0697d6a8e82c0aa856f8c17b5a7b97905a365e75))
* **platform:** add difficulty-adaptive context loader ([efe2bf8](https://github.com/HSKIMRobert/oh-my-agent/commit/efe2bf8838d9554fcc22a30f87cb7cbc87f196d8))
* **ralph:** re-verify all criteria each iteration with regression detection ([c6fd680](https://github.com/HSKIMRobert/oh-my-agent/commit/c6fd680667c9fe47bee20b66cafbb93d35644b1a))
* RARDO v2.1 P0 — Registry + Config + Dispatch + Doctor ([4f89b8a](https://github.com/HSKIMRobert/oh-my-agent/commit/4f89b8a90b8a338f6972e8c3416f0a6820498e19))
* **registry:** actionable error for unknown model slugs ([6467f0e](https://github.com/HSKIMRobert/oh-my-agent/commit/6467f0eeac150b6e1e53deb6517ffff372e17e54))
* **registry:** add model registry with 12 verified slugs ([16840c2](https://github.com/HSKIMRobert/oh-my-agent/commit/16840c2de8e6fcee41975070bd5ed70358dbbb53))
* **registry:** support user models.yaml override ([b751955](https://github.com/HSKIMRobert/oh-my-agent/commit/b7519551695fd0f5814aca2c0f817365478fac7e))
* **resolve:** honor legacy vendor override via runtime_profiles ([ea14658](https://github.com/HSKIMRobert/oh-my-agent/commit/ea14658ba02a39827a7d8f55e753a5f3e7896fae))
* **scholar:** add oma scholar command and skill for paper sidecars ([6149a5a](https://github.com/HSKIMRobert/oh-my-agent/commit/6149a5aa9768713c82ec071c738ea2581ec766a4))
* **scripts:** add sns:devto weekly draft generator ([e47f72c](https://github.com/HSKIMRobert/oh-my-agent/commit/e47f72c520b35db2a8670d35414d4e06b31e8590))
* **search:** add clien, okky, duckduckgo (ddgs) handlers ([09bfbb4](https://github.com/HSKIMRobert/oh-my-agent/commit/09bfbb434a3be82963c2a73d783b2c5ee389a23c))
* **skill:** add oma-image skill with clarification protocol ([7616bc6](https://github.com/HSKIMRobert/oh-my-agent/commit/7616bc61e548007b4b3f32aa49fe47097ca5469d))
* **skills/oma-frontend, benchmarks:** teach React 19 hook anti-patterns, refresh oma run ([91de585](https://github.com/HSKIMRobert/oh-my-agent/commit/91de585943b96ee708272b93d4e2f8804030b343))
* **skills:** add oma-academic-writer for academic prose ([8369a4c](https://github.com/HSKIMRobert/oh-my-agent/commit/8369a4cc6db6406c4537b8ec6c64b10c216041c8))
* **skills:** add oma-deepsec skill and /deepsec workflow ([56eb571](https://github.com/HSKIMRobert/oh-my-agent/commit/56eb571e92df7b48b27f7fa89678cad169fa4d22))
* **skills:** add oma-observability skill (33 files / 10.8k lines) ([add31cc](https://github.com/HSKIMRobert/oh-my-agent/commit/add31cc124a13ab23760c5a1c65a73bd8f96f5d4))
* **skills:** apply SSL framework and add oma-skill-creator ([18275f6](https://github.com/HSKIMRobert/oh-my-agent/commit/18275f63f452cd90b2262c6d2614bb40e758a94e))
* **skills:** strengthen oma-frontend + backend rules for benchmark gaps ([c384fd0](https://github.com/HSKIMRobert/oh-my-agent/commit/c384fd0cf8d10af24ebeef49c723a9063bfe0f85))
* **translator:** add Diff-Sync Mode to oma-translator skill ([6647b9a](https://github.com/HSKIMRobert/oh-my-agent/commit/6647b9abcc53ca0492d6fca9cdecaa0f3c52d0bc))
* **voice:** add oma-voice skill for local TTS/STT via Voicebox MCP ([3a0a7fb](https://github.com/HSKIMRobert/oh-my-agent/commit/3a0a7fb48c2ecbed80a425d837fa0a93f0e13dc8))
* **workflows:** add /docs workflow wrapping oma-docs ([5512629](https://github.com/HSKIMRobert/oh-my-agent/commit/5512629ab66edc09dffab80d83fff16ed514e561))
* **workflows:** add cost-cap termination to Review Loop ([82d5f8b](https://github.com/HSKIMRobert/oh-my-agent/commit/82d5f8bfb84353265a05d1e92bb46abfdee9b264))
* **workflows:** add recap workflow for oma-recap ([1d328ef](https://github.com/HSKIMRobert/oh-my-agent/commit/1d328ef4c539d9cb695a34c84ec37a6f445584ec))
* **workflows:** bias brainstorm and work loops toward structural fixes ([50ce165](https://github.com/HSKIMRobert/oh-my-agent/commit/50ce16541b2aa2fba9d6bbe9319a4497d56ca609))


### Bug Fixes

* address code review on PR [#270](https://github.com/HSKIMRobert/oh-my-agent/issues/270) ([a9d22d5](https://github.com/HSKIMRobert/oh-my-agent/commit/a9d22d5d265027ddc5c879f4cd823bee7c1a130a))
* **agent:** import session-cost helpers into spawn-status ([c54d087](https://github.com/HSKIMRobert/oh-my-agent/commit/c54d08748383780244b657e12acb8d0bdbd5abec))
* **benchmarks:** build-report gallery row fuzzy match ([fcd67ed](https://github.com/HSKIMRobert/oh-my-agent/commit/fcd67ed834d85b9bbdbffb2d89fc6e49699cbb8a))
* **benchmarks:** drop gradient hero text in oma landing ([c9f6e13](https://github.com/HSKIMRobert/oh-my-agent/commit/c9f6e136558e8dda3d4d816deb2ad1c0f222ede2))
* **benchmarks:** macOS reproducibility + auto-score robustness + prompt move ([9439c0e](https://github.com/HSKIMRobert/oh-my-agent/commit/9439c0eddec5ea36823505ce8b3e9e79d4e51b30))
* **ci:** prevent sync-manifest race conditions with concurrency and retry ([dc03410](https://github.com/HSKIMRobert/oh-my-agent/commit/dc03410e90775ebc23cf73d2dc23158ed3793a36))
* **cli:** escape inner quote in checkSqlInjection grep pattern ([#265](https://github.com/HSKIMRobert/oh-my-agent/issues/265)) ([20938c6](https://github.com/HSKIMRobert/oh-my-agent/commit/20938c64915ac533440cc6f8393e392f332abc97))
* **cli:** normalize Windows paths in docs resolver and self-update ([6345f36](https://github.com/HSKIMRobert/oh-my-agent/commit/6345f36b6bc13fc1ba835c8fd159d0e7b9576a53))
* **cli:** use platform separator in isInIgnoredSet for Windows ([e4945b1](https://github.com/HSKIMRobert/oh-my-agent/commit/e4945b1d22fbc14adcfea3590b6dc3ffef021585))
* **codex:** rename codex_hooks → hooks and migrate deprecated key ([f3e6474](https://github.com/HSKIMRobert/oh-my-agent/commit/f3e64740724b2a50a4781d09bfec034ee90dbcaf))
* **composer:** sanitize frontmatter per-vendor to stop R14 effort leak ([cb1d729](https://github.com/HSKIMRobert/oh-my-agent/commit/cb1d7299879cca5b24434dcd9ffdf444a7401872))
* **config:** migrate source repo oma-config.yaml to model_preset schema ([babec96](https://github.com/HSKIMRobert/oh-my-agent/commit/babec968a2ef81cfbed52244fa954e7df35fab09))
* **docs:** clean up unused import and any-typed test fixtures ([05cc267](https://github.com/HSKIMRobert/oh-my-agent/commit/05cc2674fc85dae259fdb896017edbadab80e82b))
* **docs:** normalize i18n-drift paths to POSIX on Windows ([5184bda](https://github.com/HSKIMRobert/oh-my-agent/commit/5184bda30111c99566d849f5d79e2604a1f6be05))
* **docs:** normalize path separator on Windows for generated/ exclusion ([b85575e](https://github.com/HSKIMRobert/oh-my-agent/commit/b85575e5b68fe6e8d3665698dc7f62408a2bdbd2))
* **docs:** reduce extractor false positives and add resolve fallback prefixes ([e863875](https://github.com/HSKIMRobert/oh-my-agent/commit/e86387594a82674dfbd4ff4671ab80a6dcdb8623))
* **docs:** scope script refs to inline code and walk all ancestors ([01bd8ec](https://github.com/HSKIMRobert/oh-my-agent/commit/01bd8ecbaa4d62630513c42b2a5a3e1dbd82d249))
* **doctor:** bound CLI version probe with spawn timeout race ([edcf523](https://github.com/HSKIMRobert/oh-my-agent/commit/edcf523f384136d0838a881144428ed41042c5c4))
* **doctor:** resolve model slug from defaults when user-pref is legacy ([08454ae](https://github.com/HSKIMRobert/oh-my-agent/commit/08454ae72b6935555e0934c1100dd480b84f03bb))
* **doctor:** walk parent dirs when discovering .agents config ([6aae72f](https://github.com/HSKIMRobert/oh-my-agent/commit/6aae72f5d910b1ee91115813537c8bb7cb805b37))
* **hooks/keyword-detector:** align CLI-invocation guard with vendor source of truth ([3c469dd](https://github.com/HSKIMRobert/oh-my-agent/commit/3c469dd3687d7aedc16ca86368c24f50a74791e2))
* **hooks/keyword-detector:** close fullwidth/hyphen bypasses and add CLI invocation guard ([3dfc2dc](https://github.com/HSKIMRobert/oh-my-agent/commit/3dfc2dc1d3998e29b1dc9223de237a3baf01b78c))
* **hooks/keyword-detector:** require explicit CLI signal for oma-family brands ([9be137a](https://github.com/HSKIMRobert/oh-my-agent/commit/9be137a2761748d158f5e26fd0fcf0c45d98cf03))
* **hooks:** guard keyword-detector against retrigger loops (R17) ([ad01209](https://github.com/HSKIMRobert/oh-my-agent/commit/ad012090029684c5a1a9a69142798ff88e15e3a4))
* **hooks:** inject SKILL.md for explicit Claude slash skills ([daaa41d](https://github.com/HSKIMRobert/oh-my-agent/commit/daaa41d2b3027fd1cda498cc8a81aa3c90d81ea6))
* **hooks:** normalize skill paths to POSIX form for Windows CI ([96a0044](https://github.com/HSKIMRobert/oh-my-agent/commit/96a004436e6488b7e85b6af70ca591bf87d187e1))
* **hooks:** suppress ralph false-positive on meta-discussion prompts ([88307cf](https://github.com/HSKIMRobert/oh-my-agent/commit/88307cff4a297e0ae4d850a35489a34fd6b35ff6))
* **image:** address code-review feedback on --reference flag ([405f916](https://github.com/HSKIMRobert/oh-my-agent/commit/405f916659fac9bfd662f17af0cc6ed3d1f11fc4))
* **image:** align reference-error UX and Gemini doc with CLI-first concept ([2fe8cb5](https://github.com/HSKIMRobert/oh-my-agent/commit/2fe8cb56fcd043625bec48f86b41bf177e36e42c))
* **image:** terminate codex exec args with -- before instruction ([#293](https://github.com/HSKIMRobert/oh-my-agent/issues/293)) ([85252cf](https://github.com/HSKIMRobert/oh-my-agent/commit/85252cfd094ba5a90045392a6b2341a2813857e8))
* **install,doctor:** bootstrap oma-config.yaml + fix doctor missing-skill repair ([#307](https://github.com/HSKIMRobert/oh-my-agent/issues/307)) ([f916ec6](https://github.com/HSKIMRobert/oh-my-agent/commit/f916ec6f7aca82e1e9a1fba0f5731ea80bd3b6c5))
* **install:** isolate test env from CI=true, mock missing copilot installer ([403f100](https://github.com/HSKIMRobert/oh-my-agent/commit/403f100375a5205f38c347317f89b1674e373415))
* **install:** remove dangling symlinks during oma install ([31f1525](https://github.com/HSKIMRobert/oh-my-agent/commit/31f1525f4b11aa2b6e52035500577a376bf46054))
* **io:** honor oma-config.yaml for per-agent dispatch and quota cap ([bbe96b3](https://github.com/HSKIMRobert/oh-my-agent/commit/bbe96b3dd5afdcc16f6f69055874aa54f97afd98))
* **io:** honor oma-config.yaml in resolveAgentPlan and loadQuotaCap ([15ea4d9](https://github.com/HSKIMRobert/oh-my-agent/commit/15ea4d9305f8b6c7b386c291d17ab6fa327326c4))
* **io:** validate sessionId to prevent path traversal ([6f5369e](https://github.com/HSKIMRobert/oh-my-agent/commit/6f5369eda2b1a05619a59d117f5bcac855474283))
* **link:** generate copilot workflow prompts on oma link ([10e3c88](https://github.com/HSKIMRobert/oh-my-agent/commit/10e3c88041d856a9729b4c5f33eda6458184da92))
* **model-registry:** drop fake api_only fixture and startup warn ([7ee7caf](https://github.com/HSKIMRobert/oh-my-agent/commit/7ee7caf355507691ee3666136a65fde3db250ad2))
* **oma-frontend:** enforce Next.js 16 proxy.ts and ban middleware.ts ([39d2a54](https://github.com/HSKIMRobert/oh-my-agent/commit/39d2a54a9f94b23c5aafc335ff4af3327c99e9cb))
* **qwen:** detect deprecated OAuth sessions and print migration guide ([fe399f7](https://github.com/HSKIMRobert/oh-my-agent/commit/fe399f7442b10d7d55ee91538f54c7050d0430c8))
* **skills/oma-frontend:** correct a11y anti-patterns in Card snippet ([a596060](https://github.com/HSKIMRobert/oh-my-agent/commit/a59606075ef3bbc0dae57dfde196573bbfc3f0fe))
* **skills:** expand oma-frontend keyword triggers ([2dddddd](https://github.com/HSKIMRobert/oh-my-agent/commit/2dddddd067ee047eebbd0233b805d356ce598eaa))
* **typecheck,biome:** resolve pre-existing errors ([9948947](https://github.com/HSKIMRobert/oh-my-agent/commit/99489478debdc274decf04102fddea0b5ee0d24e))
* **typecheck:** resolve @types/node v24/v25 conflict and strict test errors ([3ec0255](https://github.com/HSKIMRobert/oh-my-agent/commit/3ec02552a1a588583b1c140e46733dfae16e7d4c))
* **variants:** correct gemini modelDefault to gemini-3-flash ([b1f276f](https://github.com/HSKIMRobert/oh-my-agent/commit/b1f276f1d9230f2fa14dc337ebf2d90cb2d9b627))
* **vendors:** harden qwen OAuth detection and codex effort typing ([5f81a98](https://github.com/HSKIMRobert/oh-my-agent/commit/5f81a9822d7a07ad0f4543b3a5fdbc95e7dcf9bf))


### Performance

* **web:** enable Docusaurus Faster (Rspack/SWC) and drop webpack override ([139378f](https://github.com/HSKIMRobert/oh-my-agent/commit/139378f497531c677a8e62136c445a59bb4e5881))


### Refactoring

* **apm:** use plugin.json custom paths, remove .apm mirror ([e943ed4](https://github.com/HSKIMRobert/oh-my-agent/commit/e943ed49579a3be3dc6c36838d9999abbb01237d))
* **benchmarks:** move design.md from docs/ to benchmarks/ ([79c4b36](https://github.com/HSKIMRobert/oh-my-agent/commit/79c4b36afdddab729b9d69234073a7640ccae7d0))
* **cli:** consolidate vendor list to a single source of truth ([ef03ac4](https://github.com/HSKIMRobert/oh-my-agent/commit/ef03ac4f558aad0e7e8b9266fb4624bb22ec7ffe))
* **cli:** merge cli-kit/ into utils/ ([71bf0b9](https://github.com/HSKIMRobert/oh-my-agent/commit/71bf0b94e603e27837195f312d2566843ec0553a))
* **cli:** remove oma export command ([f2cb7a7](https://github.com/HSKIMRobert/oh-my-agent/commit/f2cb7a75d8b06009743b0422685a1e57de8c3b05))
* **config:** drop legacy user-preferences.yaml read paths ([305fc4e](https://github.com/HSKIMRobert/oh-my-agent/commit/305fc4e6e5c7719291989a67b84e89b4a68ee432))
* **config:** remove unused effort_matrix block from defaults.yaml ([76f0ef4](https://github.com/HSKIMRobert/oh-my-agent/commit/76f0ef40ccb2e8b9aa592e352171289e0c8cef41))
* **hooks:** split types.ts into types-only + fs-utils + hook-output ([e3f48f1](https://github.com/HSKIMRobert/oh-my-agent/commit/e3f48f1886896907a7d2bd5539d31d07fa9f0a5d))
* **io:** split runtime-dispatch and add cursor vendor support ([5f83f79](https://github.com/HSKIMRobert/oh-my-agent/commit/5f83f79658fbfb37d5ad61fb84d105a140ac07cc))
* **oma-frontend:** drop low-value resources, hoist stack files inline ([6ea9398](https://github.com/HSKIMRobert/oh-my-agent/commit/6ea93988ddfbfb3f70a5d8b621a992b09fe6e88f))
* **oma-observability:** remove process-theater metadata ([d37891a](https://github.com/HSKIMRobert/oh-my-agent/commit/d37891ab11ed7eba2cec1aac7f3f6b992adfc2ae))
* **workflows:** merge /exec-plan into /plan with structured docs/plans/ layout ([e634da3](https://github.com/HSKIMRobert/oh-my-agent/commit/e634da3b8d55bd7d5f4815b2a4742f9d8561f929))


### Documentation

* **academic-writer:** reframe HD-grade as publication-grade ([27150c0](https://github.com/HSKIMRobert/oh-my-agent/commit/27150c0ba5a2701c4a4dd11378f640efd8b2fb1a))
* add CITATION.cff with release-please auto-versioning ([f081b04](https://github.com/HSKIMRobert/oh-my-agent/commit/f081b048efa685ea0acb46032ecf8283cea59909))
* **api-contracts:** align _shared/api-contracts path to _shared/core/api-contracts ([1edd5bf](https://github.com/HSKIMRobert/oh-my-agent/commit/1edd5bf96e8ef30e8e6b7b36e6ba8ec407ff40a4))
* **benchmarks:** add generated report, screenshots, and harness outputs ([3472c54](https://github.com/HSKIMRobert/oh-my-agent/commit/3472c54bbb52bfc844a1df0bfbb9c7e1ebd36e89))
* **benchmarks:** add Korean translation README.ko.md ([182b69e](https://github.com/HSKIMRobert/oh-my-agent/commit/182b69e3f8ec6c3e0a5824f5bbc3d23cbffabfce))
* **benchmarks:** frame oma's lint -5 as intentional design principle ([3512aae](https://github.com/HSKIMRobert/oh-my-agent/commit/3512aae154942556b239818e2dfde51d062a36ca))
* **benchmarks:** re-capture oma + omc screenshots at consistent viewport ([fd0a74d](https://github.com/HSKIMRobert/oh-my-agent/commit/fd0a74d11db604b928abd0f7f22b1c6a7faf0b67))
* **benchmarks:** update README to reflect oma rerun (88 -&gt; 75.5) ([11b50f1](https://github.com/HSKIMRobert/oh-my-agent/commit/11b50f1058a42710c18e0b79b6b31bbb11f3f114))
* **claude:** regenerate CLAUDE.md rules table ([a7771db](https://github.com/HSKIMRobert/oh-my-agent/commit/a7771dbe53c6a79316a8e2f7d7a9c465111f38ce))
* **cli:** sync README Per-Agent Models section ([be3c51b](https://github.com/HSKIMRobert/oh-my-agent/commit/be3c51bdea4756fc0a80418c5715922990d348f5))
* **cli:** sync README skill table (auto) ([7507489](https://github.com/HSKIMRobert/oh-my-agent/commit/75074899ae21b228bc13cf08f5f00b8b0271eb96))
* collapse APM install section into accordion across all locales ([cfb7e1f](https://github.com/HSKIMRobert/oh-my-agent/commit/cfb7e1f833b9c4cc0da603d0383330576ffeca50))
* **config:** cite OpenRouter slug format and CLI-only filter ([049577f](https://github.com/HSKIMRobert/oh-my-agent/commit/049577f08db20586eab2ac34be4dcdcd48266af5))
* **config:** move resolution-order comment below the keys it describes ([c90a33a](https://github.com/HSKIMRobert/oh-my-agent/commit/c90a33a0bfb302842acf9d3f42f7000d541bf8d6))
* drop hardcoded skill count and stale subagent paragraph ([424824b](https://github.com/HSKIMRobert/oh-my-agent/commit/424824b1502f7183e31b4de6d32ae84111d51726))
* drop RARDO codename, fix slug bugs, consolidate oma-config.yaml references ([ef6630e](https://github.com/HSKIMRobert/oh-my-agent/commit/ef6630ef13f4ce470e3db41cd6f0085ab881f02e))
* **image:** fix swapped exit-code labels in auto-mode reference comment ([4f2b5a2](https://github.com/HSKIMRobert/oh-my-agent/commit/4f2b5a2ae886262b31a0a424ace5e51219c8c8e2))
* **image:** mandate auto-forward of attached references ([072c555](https://github.com/HSKIMRobert/oh-my-agent/commit/072c5550271acad040ada71b6845d432a278dd39))
* **image:** require agents to auto-forward attached references ([a9ee1fc](https://github.com/HSKIMRobert/oh-my-agent/commit/a9ee1fce3d210ff63fe1ad6516f80829dde1df65))
* list cursor-only preset across guides and i18n locales ([afe62b4](https://github.com/HSKIMRobert/oh-my-agent/commit/afe62b481a2b75f0bfe2e4a14aaa6660ab1dbedc))
* **observability:** condense matrix.md caveats section ([851dca8](https://github.com/HSKIMRobert/oh-my-agent/commit/851dca80a1bd89f6e700ab95e998ab070297b88f))
* **oma-docs:** sync skill and ARCHITECTURE to no-LLM-call pattern ([e38dc57](https://github.com/HSKIMRobert/oh-my-agent/commit/e38dc57f7269c558c0d12e6a390047c799879e6e))
* **oma-frontend:** wire DESIGN.md as visual source of truth ([671dc60](https://github.com/HSKIMRobert/oh-my-agent/commit/671dc6017a97ab74e3ffacc7bcc29ea3c04c6935))
* **oma-pm:** unify plan secondary output to result-pm.md ([f797932](https://github.com/HSKIMRobert/oh-my-agent/commit/f797932fcb9ff85bccbd5dfef0489310b1a2fe27))
* **readme:** add localized references section with APA 7 citation ([ffb7aed](https://github.com/HSKIMRobert/oh-my-agent/commit/ffb7aed1ed735771debb8a734ebce6693a00e9eb))
* **readme:** add oma-academic-writer, oma-market, oma-voice rows ([e2598c9](https://github.com/HSKIMRobert/oh-my-agent/commit/e2598c9c2255fa56f6156e9e527df9034371cd7f))
* **readme:** add oma-docs row to skill table in all locales ([7dea938](https://github.com/HSKIMRobert/oh-my-agent/commit/7dea9388d3d1356a44b0cff223744729069a1a3a))
* **readme:** add oma-image row to skill table in all locales ([90de0f4](https://github.com/HSKIMRobert/oh-my-agent/commit/90de0f4deaee4cd51a440d6ad1877d016c950761))
* **readme:** add oma-observability to agent team table ([64e478d](https://github.com/HSKIMRobert/oh-my-agent/commit/64e478dfc6a71b1f3abc034342c370458e2ea0ea))
* **readme:** add oma-scholar to agent table ([45225f3](https://github.com/HSKIMRobert/oh-my-agent/commit/45225f30cc9cc7e96aa2fd4da7066f39d0c02c5f))
* **readme:** correct APM install scope (hook ships, rules/workflows don't) ([15d30cb](https://github.com/HSKIMRobert/oh-my-agent/commit/15d30cb2248a9f2eb9dd3ebe954d5d4bdec9b344))
* **readme:** drop em dashes from agent team table ([c35a051](https://github.com/HSKIMRobert/oh-my-agent/commit/c35a051ce40b0d845ccc2c5cbc519e073c05b807))
* **readme:** drop knows sidecar mention from oma-scholar row ([f287bf0](https://github.com/HSKIMRobert/oh-my-agent/commit/f287bf0561cab12edd7c58da4a675e60f1925daa))
* **readme:** drop redundant '(Vercel deepsec)' parenthetical ([3901bb5](https://github.com/HSKIMRobert/oh-my-agent/commit/3901bb577e9292020d97f16a925a1b688cf1f465))
* **readme:** hide oma-coordination from agent team table ([817377e](https://github.com/HSKIMRobert/oh-my-agent/commit/817377eb03eab6a320d448011d93772a8cd49928))
* **readme:** list cursor-only preset in per-agent-models section ([230daef](https://github.com/HSKIMRobert/oh-my-agent/commit/230daef0a68294270cd9a7eb210a2d679787511b))
* **readme:** rewrite oma-docs row with sibling-matched form across locales ([254aa80](https://github.com/HSKIMRobert/oh-my-agent/commit/254aa80f38ff7b1799b3df8c1cbe7c8e9e697217))
* **readme:** sort CLI examples alphabetically and localize ([6a499b3](https://github.com/HSKIMRobert/oh-my-agent/commit/6a499b324132b1e1bd0714fc32be7856d33ee28e))
* reference per-agent models from root README and docs/* ([7760f59](https://github.com/HSKIMRobert/oh-my-agent/commit/7760f592b079207c79459958fb1d9359bcbcb6ab))
* reflect oma-observability + 5 missing agents and fix counts ([67e9da0](https://github.com/HSKIMRobert/oh-my-agent/commit/67e9da03000a84636872a88c5315e33361941442))
* remove /tools and /pdf entries from README ([228fea9](https://github.com/HSKIMRobert/oh-my-agent/commit/228fea900a44402c78468562c5c2743dfff1911c))
* remove exec-plan and stack-set from slash command table ([85cf5f5](https://github.com/HSKIMRobert/oh-my-agent/commit/85cf5f578455dcdc9dfb6b5e96ba48626167e501))
* **skill/oma-image:** link prompt galleries and clean stale docs ([0f0ad16](https://github.com/HSKIMRobert/oh-my-agent/commit/0f0ad16451edc42dca408cadb7f3625c17e7ebc2))
* **skills/oma-translator:** add sibling-pattern check and mechanical-swap guard ([148e50a](https://github.com/HSKIMRobert/oh-my-agent/commit/148e50a609dbadd4e91564cd0d607bd275ae3a07))
* sync README and web docs with current CLI surface ([34c9f52](https://github.com/HSKIMRobert/oh-my-agent/commit/34c9f521de0ba96770434456d0c332993aebcaa8))
