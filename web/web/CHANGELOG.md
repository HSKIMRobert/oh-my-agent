...
## [4.0.0](https://github.com/HSKIMRobert/oh-my-agent/compare/web-v3.1.1...web-v4.0.0) (2026-05-21)
...
* **benchmarks:** sync oma score to 80.6 across all locales ([fd66b76](https://github.com/HSKIMRobert/oh-my-agent/commit/fd66b76b9408df36aebd15898bbdcc644f5f60a1))
...
* **i18n:** catch up 11 locales with current English source ([9b52e69](https://github.com/HSKIMRobert/oh-my-agent/commit/9b52e694a0c6395d7200d58c78d17bf595c6197a))
* **i18n:** restructure em-dashes in CJK locales (ko/ja/zh) ([8d426d5](https://github.com/HSKIMRobert/oh-my-agent/commit/8d426d5c3e2f968a97e3034a2f75aa73da29aaa5))
* **i18n:** sync 11 locales with auto-detection updates ([e08b953](https://github.com/HSKIMRobert/oh-my-agent/commit/e08b95316bd8250a350288d860b0156e06d389a2))
* **i18n:** translate per-agent-models.md into 11 locales ([d8331b5](https://github.com/HSKIMRobert/oh-my-agent/commit/d8331b5e307e9358fd1adb54c73e7db9cc363ff7))
* **image-generation:** add 'Use as a Skill' section in 12 languages ([cfbc97f](https://github.com/HSKIMRobert/oh-my-agent/commit/cfbc97f0caa5edc1b20f4b52910d89cb71adfa24))
* **image:** document -r/--reference flag in web CLI reference ([d3c1878](https://github.com/HSKIMRobert/oh-my-agent/commit/d3c1878cc7bbd5d33ae4893952b2a47c9276f56a))
...
* **per-agent-models:** fix installer claim and doctor sample output ([c92a1f4](https://github.com/HSKIMRobert/oh-my-agent/commit/c92a1f43946fc82179ab54f5f3c55330121d4cfc))
* **per-agent-models:** sync EN source + 11 locales to oma-config.yaml ([6adada3](https://github.com/HSKIMRobert/oh-my-agent/commit/6adada36f5eec1c6c55cad885c6feb7c16831fb5))
* **per-agent-models:** sync EN source + 11 locales to oma-config.yaml ([680968f](https://github.com/HSKIMRobert/oh-my-agent/commit/680968f01fa0ce240d0eef533c2ac0f7aeff63de))
...
* **web:** add benchmarks page with 11 locale translations ([ce62a09](https://github.com/HSKIMRobert/oh-my-agent/commit/ce62a09efd7ca3e1e64ddab05f74180b4a8378ff))
* **web:** add oma-image generation guide in 12 languages ([e8d51c0](https://github.com/HSKIMRobert/oh-my-agent/commit/e8d51c0420422bc573a2ea1d6d89f6982c524387))
* **web:** add per-agent models guide across 12 locales ([aae25bd](https://github.com/HSKIMRobert/oh-my-agent/commit/aae25bdfb579e8a0438fee0f7a6a2329cf1e25cb))
* **web:** correct project-structure for Docusaurus and workspace commands ([4823a3b](https://github.com/HSKIMRobert/oh-my-agent/commit/4823a3b6a02278cd240e736b7a0a179edd1440f2))
* **workflows:** document /deepsec across all locales ([41a68df](https://github.com/HSKIMRobert/oh-my-agent/commit/41a68dff35ace3cd6143d6727e507de7498e022f))
* **workflows:** document patterns field and language convention ([977457f](https://github.com/HSKIMRobert/oh-my-agent/commit/977457f1da99c3e2b5ec5012b9593266435e82b6))
