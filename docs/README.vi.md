...
| **oma-deepsec** | Điều khiển Vercel deepsec — quét lỗ hổng bằng agent, gate PR, matcher tùy chỉnh |
...
| 4 | `/deepsec` | Quét bảo mật chuyên sâu bằng agent qua Vercel deepsec |
