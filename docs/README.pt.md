...
| **oma-deepsec** | Conduz o Vercel deepsec — varredura de vulnerabilidades por agente, gate de PR, matchers personalizados |
...
| 4 | `/deepsec` | Varredura de seguranca profunda por agente via Vercel deepsec |
