...
| **oma-deepsec** | Conduce Vercel deepsec — escaneo de vulnerabilidades por agente, gate de PR, matchers personalizados |
...
| 4 | `/deepsec` | Escaneo de seguridad profundo por agente vía Vercel deepsec |
