...
| **oma-deepsec** | Pilote Vercel deepsec — scan de vulnérabilités par agent, gate PR, matchers personnalisés |
...
| 4 | `/deepsec` | Scan de sécurité profond par agent via Vercel deepsec |
