...
| **oma-deepsec** | Stuurt Vercel deepsec aan — agent-gedreven vulnerability scanning, PR-gate, eigen matchers |
...
| 4 | `/deepsec` | Diepe agent-gedreven security scan via Vercel deepsec |
