...
| **oma-deepsec** | Steuert Vercel deepsec — agent-basiertes Vulnerability-Scanning, PR-Gate, eigene Matcher |
...
| 4 | `/deepsec` | Tiefer agent-basierter Security-Scan via Vercel deepsec |
