...
| **oma-deepsec** | Steruje Vercel deepsec — skanowanie podatnosci przez agenta, bramka PR, wlasne matchery |
...
| 4 | `/deepsec` | Gleboki skan bezpieczenstwa przez agenta z Vercel deepsec |
