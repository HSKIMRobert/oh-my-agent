...
| **oma-deepsec** | Управляет Vercel deepsec — агентное сканирование уязвимостей, PR-шлюз, собственные matcher'ы |
...
| 4 | `/deepsec` | Глубокое агентное сканирование безопасности через Vercel deepsec |
